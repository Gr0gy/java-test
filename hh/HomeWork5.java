...
public class HomeWork5 {
     ...
     * Поля класса - name:String, protection:Integer, health:Integer (+конструктор,
     * +геттеры)
     ...
     * Метод - String announce() {} - возвращает строку в формате
     * "Person /name/ имеет характеристики: /health/ здоровья и /protection/ защиты"
     * Метод - void takeDamage(Integer damage) {} - вычитает урон из здоровья
     * персонажа по формуле health - (damage - protection)
     ...
     * Метод(Переопределить) announce - возвращает строку в формате Mage + вызов
     * метода announce у родителя
     ...
     * Метод(Переопределить) announce - возвращает строку в формате Archer + вызов
     * метода announce у родителя
     * Метод(Переопределить) takeDamage - вычитает урон из здоровья персонажа
    ...
    public static class Mage extends Person {
        // Напиши здесь свою реализацию класса Mage (не забудь про наследование от
        // Person)
    }

    public static class Archer extends Person {
        // Напиши здесь свою реализацию класса Archer (не забудь про наследование от
        // Person)
    }
     ...
     * Некоторые методы в тесте подсвечены красным - это значит что компилятор не
     * может их найти.
